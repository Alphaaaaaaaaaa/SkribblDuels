...
const rebalancedChallengeIds = new Set([
  ...
  'transcended', 'ate-and-left-no-crumbs', 'guessingoat', 'drop-streak',
...
assertEqual(engine.getDefinitionIds().length, 53, 'Fifty-three official starter definitions should exist.');

const activated = activateStarterSandbox(engine);
assertEqual(activated.length, 53, 'Fifty-three starter sandbox instances should activate.');
