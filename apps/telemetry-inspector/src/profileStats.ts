...
const definitions: ProfileStatDefinition[] = [
  ...
  { id: 'p90-guess-time', label: 'P90 guess time', description: 'Fastest-decile threshold (90th performance percentile) of the latest 512 correct-guess times.', fallback: 'T90', value: s => duration(s.guessing.p90GuessTimeMs) },
