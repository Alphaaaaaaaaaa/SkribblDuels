# Skribbl Duels Gateway Foundation v0.37.0
...
See `docs/gateway-auth-handshake-v0.37.0.md`, `docs/profile-foundation-v0.36.0.md`, `docs/auth-foundation-v0.35.0.md`, and `docs/environment-configuration.md`.
