...
The 30-second ready deadline, 15-second draft deadline and 10-second pre-match
countdown are authoritative server constants; no additional Railway variable
is required for v0.40.0.
